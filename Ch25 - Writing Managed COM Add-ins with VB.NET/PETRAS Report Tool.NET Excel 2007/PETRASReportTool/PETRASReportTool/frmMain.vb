...
#Region "Module-wide variables."
    'Create and instantiate new instances of the classes.
    Private mcReports As New CDataReports()
    Private mcXLMExport As New CExportXML()
    Private mcMethods As New CCommonMethods()
...
#Region "Windows Form section."
    ...
    '                                           worker component 
    ' 09/11/08      Dennis Wallentin    Ch25    Added
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, _
        ...
        Me.HelpProvider1.HelpNamespace = mcMethods.Get_Path + sHELPNAMESPACE
    ...
    Private Sub BackgroundWorker1_DoWork(ByVal sender As Object, _
        ...
        If mcReports.bConnect_Database() = False Then
    ...
    Private Sub BackgroundWorker1_RunWorkerCompleted(ByVal sender As Object, _
        ...
        If mbIsConnected Then
            ...
            mdtClients = mcReports.dtGet_Clients
    ...
    Private Sub cboClients_SelectedIndexChanged(ByVal sender As System.Object, _
        ...
        If mbLoadClientsList = True Then
            ...
            If Me.cboClients.SelectedIndex >= 0 Then
                ...
                With Me.cboProjects
                    .DataSource = mcReports.dtGetProjects_Client( _
    ...
    Private Sub cmdClose_Click(ByVal sender As System.Object, _
        ...
        If (mcReports IsNot Nothing) Then mcReports = Nothing

        If Not IsNothing(Expression:=mcXLMExport) Then mcXLMExport = Nothing

        If (mcMethods IsNot Nothing) Then mcMethods = Nothing
...
#Region "Export and validating."
    ...
    Private Sub cmdCreateReport_Click(ByVal sender As Object, _
        ...
        If Me.cboClients.SelectedIndex <> -1 And Me.cboProjects.SelectedIndex <> -1 Then
            ...
            If Me.chkConsultants.Checked = False And Me.chkActivities.Checked = True Then
                ...
                mdtTable = mcReports.dtActivities(lnProjID:=iProjectID, _
            ...
            Else
                ...
                If Me.chkConsultants.Checked = True And Me.chkActivities.Checked = True Then
                    mdtTable = mcReports.dtActivities_Consultants(lnProjId:=iProjectID, _
                                                                     dtStart:=Me.dtpStartDate.Value.Date, _
                                                                     dtEnd:=Me.dtpEndDate.Value.Date)
                Else
                    ...
                    If Me.chkConsultants.Checked = True And Me.chkActivities.Checked = False Then
                        mdtTable = mcReports.dtConsultants(lnProjId:=iProjectID, _
                                                              dtStart:=Me.dtpStartDate.Value.Date, _
                                                              dtEnd:=Me.dtpEndDate.Value.Date)
                    Else

                        'Exclude both the activities and consultants.
                        mdtTable = mcReports.dtSummary(lnProjId:=iProjectID, _
                                                          dtStart:=Me.dtpStartDate.Value.Date, _
                                                          dtEnd:=Me.dtpEndDate.Value.Date)
                    End If
                End If
    ...
    Private Sub cmdExportExcel_Click(ByVal sender As System.Object, _
        ...
        Dim cXLExport As New CExportExcel()
        ...
        If mcMethods.bFile_Exist() Then

            'Call the export to Excel function.
            If cXLExport.bExport_Excel(dtTable:=mdtTable, _
        ...
        Else
            ...
            MessageBox.Show(text:="Please make sure that the Excel template file " + vbNewLine + _
                            mcMethods.Get_Path + swTemplateListArr(swshSelectedTemplate) + vbNewLine + _
                            "actually exists.", _
                            caption:=swsCaption, _
                            buttons:=MessageBoxButtons.OK, _
        ...
        'Prepare the object for GC.
        If (cXLExport IsNot Nothing) Then cXLExport = Nothing
    ...
    ' --------------------------------------------------------------
    ' 04/22/08      Dennis Wallentin    Ch24    Initial version
    ' 16/09/08      Dennis Wallentin            Added Class variabel
    ' 09/11/08      Dennis Wallentin    Ch25    Added
    ...
    Private Sub cmdExportXML_Click(ByVal sender As System.Object, _
        ...
        If mcXLM.bSave_DataTable_XML( _
