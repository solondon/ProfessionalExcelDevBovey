Attribute VB_Name = "MCopyTransparent"
'
' Description:  When using VB6 resources for our images, we lose the
'               transparency information.  This module contains API
'               calls to recreate the transparency information as the
'               picture is being copied to the clipboard, ready to be
'               PasteFace'd onto the toolbar.  This is only required
'               for Excel 2000, as we can set the Picture and Mask
'               directly in later versions
'
' Authors:      Rob Bovey, www.appspro.com
'               Stephen Bullen, www.oaltd.co.uk
'
' Ch23 - Added the module, copied from MS KB Article 288771
'
Option Explicit
