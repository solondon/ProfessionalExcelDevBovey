...
Module MDataReports
    ...
    Private ReadOnly msConnection As String = My.Settings.SQLConnection.ToString()
    ...
    Friend Function bConnect_Database() As Boolean
        ...
        Do While bStatusConnection = Nothing
            ...
            Try
                ...
                SqlCon = MDataReports.sqlCreate_Connection()
...
#Region "Retrieve the data from the database."
    ...
    Friend Function dtGet_Clients() As DataTable
        ...
        Try
            ...
            adpSql = New SqlDataAdapter(selectCommandText:=sSqlQuestion, _
                                        selectConnection:=MDataReports.sqlCreate_Connection)
    ...
    ' Date          Developers          Chap    Action
    ' --------------------------------------------------------------
    ' 04/24/08      Dennis Wallentin    Ch24    Initial version
    ...
    Private Function dtGeneral_Report(ByVal sSQLQuery As String, _
        ...
        Try
            ...
            With cmdSql
                ...
                .Connection = MDataReports.sqlCreate_Connection()
            End With
...
#Region "All SQL statements."
    ...
    ' Date          Developers          Chap    Action
    ' --------------------------------------------------------------
    ' 04/27/08      Dennis Wallentin    Ch24    Initial version
    ...
    Friend Function dtActivities(ByVal lnProjID As Long, ByVal dtStart As Date, _
        ...
        Return MDataReports.dtGeneral_Report(sSQLQuery:=sSqlQuestion, dtStartDate:=dtStart, dtEndDate:=dtEnd)
    ...
    ' Date          Developers          Chap    Action
    ' --------------------------------------------------------------
    ' 04/28/08      Dennis Wallentin    Ch24    Initial version
